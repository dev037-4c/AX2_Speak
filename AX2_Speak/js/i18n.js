...
(function() {
    ...
    const translations = {
        ko: {
            ...
            'menu.lecture': '강의 번역',
            'menu.lecture_desc': '실시간 강의 번역 및 자막',
            'menu.price': '가격',
            'menu.security': '보안',
            'menu.features': '기능',
            'menu.about': '회사 소개',
            ...
            // 메인 페이지
            'main.title': '강의 번역을 시작하세요',
            'main.subtitle': '실시간으로 강의를 번역하고 다국어 자막을 제공합니다.',
            'main.dropzone': '강의 영상을 드래그하거나 클릭하여 업로드하세요',
            ...
            // index.html (메인 페이지)
            'index.title': '강의 번역을 시작하세요',
            'index.subtitle': '실시간으로 강의를 번역하고 다국어 자막을 제공합니다.',
            'index.dropzone': '강의 영상을 드래그하거나 클릭하여 업로드하세요',
            'index.fileinfo': 'MP4, MOV, AVI (최대 2GB)',
            'index.settings': '강의 번역 설정',
            'index.original': '원본 언어',
            'index.target': '대상 언어',
            'index.autodetect': '자동 감지',
            'index.generate': '강의 번역 시작',
        ...
        en: {
            // Navigation
            'nav.subtitle': 'Lecture Translation',
            'nav.pricing': 'Pricing',
            'nav.guide': 'Guide',
            'nav.login': 'Login',
            'nav.signup': 'Sign Up',
            ...
            'menu.lecture_desc': 'Real-time lecture translation & subtitles',
            'menu.price': 'Pricing',
            ...
            // Main page
            'main.title': 'Start Lecture Translation',
            'main.subtitle': 'Translate lectures in real-time and provide multilingual subtitles.',
            'main.dropzone': 'Drag or click to upload lecture video',
            ...
            // index.html
            'index.title': 'Start Lecture Translation',
            'index.subtitle': 'Translate lectures in real-time and provide multilingual subtitles.',
            'index.dropzone': 'Drag or click to upload lecture video',
            'index.fileinfo': 'MP4, MOV, AVI (Max 2GB)',
            'index.settings': 'Lecture Translation Settings',
            'index.original': 'Original Language',
            'index.target': 'Target Language',
            'index.autodetect': 'Auto Detect',
            'index.generate': 'Start Lecture Translation',
        ...
        ja: {
            ...
            'menu.lecture': '講義翻訳',
            'menu.lecture_desc': 'リアルタイム講義翻訳と字幕',
            'menu.price': '料金',
            ...
            // メインページ
            'main.title': '講義翻訳を開始',
            'main.subtitle': 'リアルタイムで講義を翻訳し、多言語字幕を提供します。',
            'main.dropzone': '講義動画をドラッグまたはクリックしてアップロード',
            ...
            // index.html
            'index.title': '講義翻訳を開始',
            'index.subtitle': 'リアルタイムで講義を翻訳し、多言語字幕を提供します。',
            'index.dropzone': '講義動画をドラッグまたはクリックしてアップロード',
            'index.fileinfo': 'MP4, MOV, AVI (最大2GB)',
            'index.settings': '講義翻訳設定',
            'index.original': '元の言語',
            'index.target': '対象言語',
            'index.autodetect': '自動検出',
            'index.generate': '講義翻訳開始',
        ...
        zh: {
            ...
            // 主页
            'main.title': '开始讲座翻译',
            'main.subtitle': '实时翻译讲座并提供多语言字幕。',
            'main.dropzone': '拖放或点击上传讲座视频',
            ...
            // index.html
            'index.title': '开始讲座翻译',
            'index.subtitle': '实时翻译讲座并提供多语言字幕。',
            'index.dropzone': '拖放或点击上传讲座视频',
            'index.fileinfo': 'MP4, MOV, AVI (最大2GB)',
            'index.settings': '讲座翻译设置',
            'index.original': '原始语言',
            'index.target': '目标语言',
            'index.autodetect': '自动检测',
            'index.generate': '开始讲座翻译',
